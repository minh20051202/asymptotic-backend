...
- **Có nguồn:** caption hình trong báo cáo phải ghi nguồn phù hợp.
...
9. Caption và nguồn hình đã đúng chưa?
...
- [ ] File source đã được lưu (`.drawio`, `.puml`, `.mmd`, v.v.).
...
- Use case tổng quát: `use_case_overview.drawio`, `use_case_overview.png`
- Activity UC01: `UC01_activity.puml`, `UC01_activity.png`
- Sequence UC01: `UC01_sequence.puml`, `UC01_sequence.png`
- Analysis class tổng quát: `analysis_class_overview.drawio`
...
- tên file trùng nhau ở nhiều thư mục;
- đổi tên file ảnh mà không cập nhật LaTeX.

## 7. Khi nào cần vẽ lại diagram?
