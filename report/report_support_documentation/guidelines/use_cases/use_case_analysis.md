...
- Object Management Group (OMG), *Unified Modeling Language, Version 2.5.1*, December 2017, Clause 18 - UseCases, trang in 638-649:  
  [formal-17-12-05.pdf](../../references/standards/formal-17-12-05.pdf)
...
- Trịnh Thành Trung, *Bài 13 - Tổng quan về UML*, tài liệu bài giảng OOAD, 2016:  
  [OOP_Bai13(vi).pdf](../../references/lectures/OOP_Bai13(vi).pdf)
...
[use_case_examples_thinhnotes/](../../references/examples/use_case_examples_thinhnotes/)

Danh mục, chú thích và mục đích sử dụng từng hình:

[README - Use Case examples from Thinhnotes](../../references/examples/use_case_examples_thinhnotes/README.md)
