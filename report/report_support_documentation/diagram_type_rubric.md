...
- Có phân loại Boundary-Control-Entity hoặc stereotype tương đương.
...
- Trạng thái là danh từ/tính từ mô tả condition, không phải action.
- Transition có event hoặc condition rõ.
...
- Có primary key, foreign key quan trọng.
...
Component Diagram trả lời câu hỏi: **Các thành phần triển khai lớn của hệ thống là gì và giao tiếp với nhau ra sao?**

### Tiêu chí đạt

- Component đại diện cho đơn vị triển khai hoặc runtime lớn.
- Có external systems.
...
- [ ] Component là đơn vị triển khai lớn.
- [ ] External system rõ.
...
- Có node runtime rõ: client, server, database, external service.
